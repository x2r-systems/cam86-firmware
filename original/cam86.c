...
void frame(void)
{
    ...
    //ñáðîñ ïåðâûõ 24 ñòðîê+ ROI è î÷èñòêà ãîðèçîíòàëüíîãî ðåãèñòðà
    ...
    clearline();
    //äëÿ âûðàâíèâàíèÿ ÿðêîñòè 1 ñòðîêè
    ...
    do
    {
        shift();
        k0 = 0x14;
        //âûêëþ÷åí s2, íåò èìïóëüñîâ çàïèñè
...
void clearline()
// Î÷èñòêà ãîðèçîíòàëüíîãî ñäâèãà. Åñëè åãî íå î÷èñòèòü,
// òî íàêîïëåííûé â íåì ïàðàçèòíûé çàðÿä áóäåò äîáàâëåí â ïåðâóþ ñòðîêó èçîáðàæåíèÿ
...
void clearframe(void)
// Î÷èñòêà ñäâèãîâîãî ðåãèñòðà. Åñëè åãî íå î÷èñòèòü,
// òî íàêîïëåííûé â íåì çàðÿä áóäåò äîáàâëåí â èçîáðàæåíèå.
// Î÷èùàåòñÿ âåñü ðåãèñòð âìåñòå ñ "òåìíûìè" è íåèñïîëüçóåìûìè ñòðîêàìè.
// Îïåðàöèÿ ïðîâîäèòñÿ ïåðåä "ñëèâîì" èçîáðàæåíèÿ â ñäâèãîâûé ðåãèñòð.
